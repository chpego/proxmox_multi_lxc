...
wget -qL https://github.com/chpego/proxmox_multi_lxc/raw/dev/psa_car_controller/setup.sh
...
info "Successfully created psa_car_controller LXC to $CTID."
msg "
